...
def feladat1(név):
    ...
    for i in range(len(lista)):
        összeg += int(lista[i])
    return összeg
def feladat2(szöveg, első, utolsó):
    lista = beolvas(szöveg)
    számok = []
...
feladat01 = feladat1("2024.03.04/input1.txt")
print("feladat1:", [(feladat01)])

feladat02 = feladat2("2024.03.04/input2", 2, 0)
print("feladat2:", [(feladat02)])

feladat03 = feladat3("2024.03.04/input3", 1, 1)
print("feladat3:", [(feladat03)])
